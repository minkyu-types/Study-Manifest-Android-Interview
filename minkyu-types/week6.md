...
- 이 보안 모델은 안드로이드의 멀티태스킹 환경의 기본이며, 시스템 안정성과 데이터 개인 정보 보호를 모두 지원함
...
- 이 생명주기의 이해를 통해 View의 초기화/렌더링/소멸을 관리하고, 사용자 작업 또는 시스템 이벤트에 응답하여 View 생명주기에 따라 커스텀 뷰를 구현하며, 적절한 시점에 리소스를 폐기하는 데 도움이 됨
